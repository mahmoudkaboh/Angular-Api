...
namespace WebApi.Controllers
{
    ...
    {
        Api_DatabaseEntities db = new Api_DatabaseEntities();
        ...
        public IHttpActionResult PutEmaployeeMaster(EmployeeDetail employee)
        {
            ...
            {
                EmployeeDetail objEmp = new EmployeeDetail();
                objEmp = db.EmployeeDetails.Find(employee.EmpId);
                if (objEmp != null)
                {
        ...
        public IHttpActionResult DeleteEmaployeeDelete(int id)
        {
            ...
            EmployeeDetail emaployee = db.EmployeeDetails.Find(id);
            if (emaployee == null)
            {
                return NotFound();
            }

            db.EmployeeDetails.Remove(emaployee);
            db.SaveChanges();
